      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          ...
          <div className="mt-10">
            ...
            />
            <div className="mt-8">
              <p className="font-semibold text-lg">React 18 Frontend support </p>
              <p className="text-gray-400 ">By Achyuth Reddy</p>
              <p className="mt-8 text-sm text-gray-400">
                𝐀𝐩𝐩𝐥𝐢𝐜𝐚𝐭𝐢𝐨𝐧 𝐄𝐧𝐠𝐢𝐧𝐞𝐞𝐫 | 𝐑𝐞𝐚𝐜𝐭𝐉𝐬 |𝐑𝐞𝐚𝐜𝐭-𝐑𝐞𝐝𝐮𝐱 | 𝐑𝐞𝐝𝐮𝐱 𝐓𝐨𝐨𝐥𝐊𝐢𝐭 | 𝐌𝐢𝐜𝐫𝐨𝐟𝐫𝐨𝐭𝐞𝐧𝐝𝐬 | 𝐉𝐒𝐎𝐍 | 𝐆𝐫𝐚𝐩𝐡𝐐𝐋 | 𝐑𝐄𝐒𝐓 𝐀𝐏𝐈𝐬 | 𝐒𝐭𝐨𝐫𝐲 𝐁𝐨𝐨𝐤 |
              </p>
              <div className="mt-3">
                <Button
                  color="white"
